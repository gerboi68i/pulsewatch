    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#04070d] px-6 text-slate-200">
      ...
      <div className="w-full max-w-sm fade-in">
        ...
        <div className="glow-soft rounded-2xl border border-white/10 bg-slate-900/60 p-8 backdrop-blur-xl">
          ...
          <p className="mt-1 text-sm text-slate-400">Start monitoring in under a minute.</p>
          <form action={action} className="mt-6 space-y-4">
            ...
            <div>
              <label htmlFor="name" className="block text-sm text-slate-300">Name <span className="text-slate-500">(optional)</span></label>
          ...
          <p className="mt-6 text-center text-sm text-slate-400">
            Already have an account? <Link href="/login" className="font-medium text-emerald-400 hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </main>
